package com.simrelay.m0.audio.vendor
...
class VendorAudioBackend : CallAudioBackend {
    override val id = AudioBackendId.VendorAudio
    ...
    private fun unavailable(operation: AudioOperation = AudioOperation.CapabilityProbe) = CallAudioCapability(
        ...
        "Vendor audio backend is not implemented in Phase 0A",
        operation = operation
    )
}
